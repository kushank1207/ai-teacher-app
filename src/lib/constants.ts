...
export interface PythonTopics {
  [key: string]: TopicSection;
}

// Detailed Python OOP Topics structure
export const PYTHON_TOPICS: PythonTopics = {
  BASICS: {
...
// Helper types for topic with section
interface TopicWithSection extends Topic {
  section: string;
}

// Helper functions for topics
export const getAllTopics = (): TopicWithSection[] => {
...
export const getTopicById = (topicId: string): TopicWithSection | null => {
